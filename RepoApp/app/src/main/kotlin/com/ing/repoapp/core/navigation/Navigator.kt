...
import com.ing.repoapp.feature.presentation.views.RepoDetailsActivity
...
@Inject constructor() {
     ...
     private fun showRepos(context: Context) = context.startActivity(ReposActivity.callingIntent(context))


    fun showRepoDetails(activity: FragmentActivity, repo: RepoView, navigationExtras: Extras) {
        val intent = RepoDetailsActivity.callingIntent(activity, repo)
       /*
